...
async function Synthwave() {
    ...
    for (let i = 0; i < lines; i++) {
        let string = "", font = defaultCreditsFont;
        ...
        const textWidth = measurement.actualBoundingBoxLeft + measurement.actualBoundingBoxRight;
        const textHeight = measurement.actualBoundingBoxAscent +
